...
import {faBed, faCalendarDay, faCamera, faCar, faPerson, faPlane, faTaxi} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="header">
            <div className={type === "list" ? "headerContainer listMode": "headerContainer"}>
                ...
                <p className="headerDesc">Travel profitably: get access to discounts from 10% with a free Booking.com
                    account.</p>
                ...
                <div className="headerSearch">
                    ...
                    <div className="headerSearchItem">
                        ...
                        <span onClick={()=>setOpenOptions(!openOptions)}
                            className="headerSearchText">{`${options.adult} adult - ${options.children} children - ${options.room}`}</span>
